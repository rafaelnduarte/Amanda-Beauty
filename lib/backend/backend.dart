...
import 'schema/event_type_record.dart';
...
export 'schema/event_type_record.dart';
...
/// Functions to query EventTypeRecords (as a Stream and as a Future).
Future<int> queryEventTypeRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      EventTypeRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<EventTypeRecord>> queryEventTypeRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      EventTypeRecord.collection,
      EventTypeRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<EventTypeRecord>> queryEventTypeRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
