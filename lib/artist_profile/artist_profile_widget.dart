...
class _ArtistProfileWidgetState extends State<ArtistProfileWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'Artist_Profile'});
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Scaffold(
        key: scaffoldKey,
        backgroundColor: FlutterFlowTheme.of(context).timberwolf,
        appBar: AppBar(
          backgroundColor: FlutterFlowTheme.of(context).timberwolf,
                          ...
                          Padding(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  logFirebaseEvent(
                                      'ARTIST_PROFILE_PAGE_Icon_nhd08ygx_ON_TAP');
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ARTIST_PROFILE_PAGE_Icon_334bbto2_ON_TAP');
                                    logFirebaseEvent('Icon_navigate_to');

                                    context.goNamed('Home_Calendar');
                                  },
                                  child: Icon(
                                    Icons.work_outline,
                                    color: FlutterFlowTheme.of(context)
                            ...
                            children: [
                                  ...
                                  children: [
                                    Padding(
                                      ...
                                      child: InkWell(
                                        ...
                                        onTap: () async {
                                          logFirebaseEvent(
                                              'ARTIST_PROFILE_PAGE_Icon_pw0uia7x_ON_TAP');
                                          logFirebaseEvent('Icon_navigate_to');
                              ...
                              Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'ARTIST_PROFILE_PAGE_Row_slsnesc7_ON_TAP');
