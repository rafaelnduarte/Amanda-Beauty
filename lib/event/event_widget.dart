      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: FlutterFlowIconButton(
            ...
            onPressed: () async {
              logFirebaseEvent('EVENT_PAGE_arrow_back_rounded_ICN_ON_TAP');
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Builder(
                              builder: (context) {
                                final artists =
                                    widget.event?.artists?.toList() ?? [];
                                return ListView.builder(
                                  padding: EdgeInsets.zero,
                                  shrinkWrap: true,
                                  scrollDirection: Axis.vertical,
                                  itemCount: artists.length,
                                  itemBuilder: (context, artistsIndex) {
                                    final artistsItem = artists[artistsIndex];
                                    return Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 12.0, 0.0, 0.0),
                                      child: StreamBuilder<List<UsersRecord>>(
                                        ...
                                        builder: (context, snapshot) {
                                          ...
                                          final proPlanUsersRecord =
                                              proPlanUsersRecordList.isNotEmpty
                                                  ? proPlanUsersRecordList.first
                                                  : null;
                                          return Container(
                                        ...
                                        child: Padding(
                                          ...
                                          child: StreamBuilder<ServicesRecord>(
                                            ...
                                            builder: (context, snapshot) {
                                              ...
                                              final textServicesRecord =
                                                  snapshot.data!;
                                              return Text(
                                                textServicesRecord.output,
                                                style:
                                                    FlutterFlowTheme.of(context)
                                                        .displaySmall
                                                        .override(
                      ...
                      Align(
                        ...
                        child: Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              logFirebaseEvent(
                                  'EVENT_PAGE_MARK_AS_COMPLETE_BTN_ON_TAP');
